...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions
{
    ...
    rect = CGRectMake(rect.origin.x,rect.origin.y,rect.size.width,350);
...
{
    rect = CGRectMake(rect.origin.x,rect.origin.y,rect.size.width,230);
...
//    [[UIColor colorWithRed:0.020 green:0.549 blue:0.961 alpha:1.] setFill];
    [[UIColor colorWithRed:0.756 green:0.756 blue:0.756 alpha:1.] setFill];
